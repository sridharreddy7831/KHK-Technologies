!(function () {
  ...
  const e = (e, t = !1) => (
    ...
    t = (t, o, s, l = !1) => {
      ...
      i &&
        (l
          ? i.forEach((e) => e.addEventListener(t, s))
    ...
    t(
      ...
      function (t) {
        e(this.hash) &&
          ...
          e(".mobile-nav-toggle").classList.toggle("fa-bars"),
          e(".mobile-nav-toggle").classList.toggle("fa-times"));
      },
      !0
    ),
  ...
  let a = e("#hero-carousel-indicators");
  ...
  if (r) {
    const t = () => {
      window.scrollY > 100 || e(".header-sticky-top")
        ? (r.classList.add("header-scrolled"),
          (e(".mobile-nav-toggle").style.color = "white"))
        : (r.classList.remove("header-scrolled"),
          (e(".mobile-nav-toggle").style.color = getComputedStyle(
            e(":root")
          ).getPropertyValue("--primary-color")));
    };
    window.addEventListener("load", t), o(document, t);
  }
  let n = document.querySelector("#preloader");
  function c() {
    window.innerWidth <= 758
      ? e(":root").style.setProperty(
          "--hero-section-height",
          `${window.innerHeight - e("#logo-header").offsetHeight}px`
        )
      : e(":root").style.setProperty("--hero-section-height", "100vh");
  }
  n &&
...
window.addEventListener('load', () => {
  ...
  }, 50000); // Waits 3000 milliseconds = 3 seconds
});
